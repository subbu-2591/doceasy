...
const Register = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Registration endpoint:", `${API_BASE_URL}/auth/register`);
      
      // Try a OPTIONS preflight request first to test connectivity
      try {
        const preflightResponse = await fetch(`${API_BASE_URL}/auth/ping`, {
          method: 'GET',
          headers: {
        ...
        console.log("Preflight response:", preflightResponse.ok ? "Success" : "Failed", preflightResponse.status);
      } catch (preflightError) {
        console.error("Preflight error:", preflightError);
      }
      ...
      const response = await fetch(`${API_BASE_URL}/auth/register`, {
        ...
        mode: 'cors' // Try without credentials first
      });
      ...
      if (data.user_id) {
        ...
        setOtp(data.dev_otp || ""); // Auto-fill in development
        setShowOTPForm(true);
